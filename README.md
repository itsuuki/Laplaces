...
## アプリ概要
Userはお店と商品を登録できたり、お店に対して店内、テイクアウト、デリバリーを選び注文することができます。
また、Tweeterのように記事を投稿することができます。
ほかに、お気に入り機能やレビュー機能によりお店を利用した他のお客様の声を聴くことができます。
コロナで飲食店などが多大なダメージを受けていると思うのでその手助けをできるものを作りたくて作りました。
